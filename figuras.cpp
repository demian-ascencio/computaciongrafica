...
void CFiguras::arquiPrincipal(GLuint frente, GLuint atras, GLuint lizq, GLuint lder, GLuint arriba)  //Funcion creacion prisma
{

	GLfloat vertice[8][3] = {
			{ 147.0, 0.0, 103.0 },     //Coordenadas Vértice 0 V0
			{ 163.0, 0.0, 103.0 },    //Coordenadas Vértice 1 V1
			{ 163.0, 0.0, 11.0 },     //Coordenadas Vértice 2 V2
			{ 147.0, 0.0, 11.0 },     //Coordenadas Vértice 3 V3
			{ 147.0, 20.0, 103.0 },     //Coordenadas Vértice 4 V4
			{ 163.0, 20.0, 103.0 },     //Coordenadas Vértice 5 V5
			{ 163.0, 20.0, 11.0 },    //Coordenadas Vértice 6 V6
			{ 147.0, 20.0, 11.0 },     //Coordenadas Vértice 7 V7
	};

	//frente
	glBindTexture(GL_TEXTURE_2D, frente);
	glBegin(GL_POLYGON);
	glNormal3f(0.0f, 0.0f, 1.0f);
	glTexCoord2f(0.0f, 0.0f); glVertex3fv(vertice[0]);
	glTexCoord2f(1.0f, 0.0f); glVertex3fv(vertice[1]);
	...
	glEnd();
	//lizq
	glBindTexture(GL_TEXTURE_2D, lizq);
	glBegin(GL_POLYGON);
	glNormal3f(-1.0f, 0.0f, 0.0f);
	...
	glEnd();
	//lder
	glBindTexture(GL_TEXTURE_2D, lder);
	glBegin(GL_POLYGON);
	glNormal3f(1.0f, 0.0f, 0.0f);
...
void CFiguras::arquiEdificioL(GLuint frente1, GLuint frenteder, GLuint frente2, GLuint atras, GLuint arriba)
{

	GLfloat vertice[13][3] = {
			{ 57.0, 0.0, 82.0 },     //Coordenadas Vértice 0 
			{ 102.0, 0.0, 82.0 },    //Coordenadas Vértice 1 
			{ 102.0, 0.0, 32.0 },     //Coordenadas Vértice 2 
			{ 147.0, 0.0, 32.0 },     //Coordenadas Vértice 3
			{ 147.0, 0.0, 14.0 },     //Coordenadas Vértice 4 
			{ 57.0, 0.0, 14.0 },     //Coordenadas Vértice 5 
			{ 57.0, 15.0, 82.0 },    //Coordenadas Vértice 6 
			{ 102.0, 15.0, 82.0 },     //Coordenadas Vértice 7 
			{ 102.0, 15.0, 32.0 },     //Coordenadas Vértice 8 
			{ 147.0, 15.0, 32.0 },     //Coordenadas Vértice 9 
			{ 147.0, 15.0, 14.0 },     //Coordenadas Vértice 10 
			{ 57.0, 15.0, 14.0 },     //Coordenadas Vértice 11
			{ 57.0, 15.0, 32.0 },     //Coordenadas Vértice 12
	};
	...
	//frenteder
	glBindTexture(GL_TEXTURE_2D, frenteder);
	glBegin(GL_POLYGON);
	...
	//frente2
	glBindTexture(GL_TEXTURE_2D, frente2);
	glBegin(GL_POLYGON);
	glNormal3f(0.0f, 0.0f, 1.0f);
	glTexCoord2f(0.0f, 0.0f); glVertex3fv(vertice[2]);
	glTexCoord2f(1.0f, 0.0f); glVertex3fv(vertice[3]);
	...
	glTexCoord2f(0.51f, 0.0f); glVertex3fv(vertice[7]);
	glTexCoord2f(0.51f, 0.71f); glVertex3fv(vertice[8]);
	glTexCoord2f(0.0f, 0.71f); glVertex3fv(vertice[12]);
	glEnd();
	...
	glNormal3f(0.0f, 1.0f, 0.0f);
	glTexCoord2f(0.0f, 0.71f); glVertex3fv(vertice[12]);
	glTexCoord2f(1.0f, 0.71f); glVertex3fv(vertice[9]);
	glTexCoord2f(1.0f, 1.0f); glVertex3fv(vertice[10]);
	glTexCoord2f(0.0f, 1.0f); glVertex3fv(vertice[11]);
	glEnd();
...
void CFiguras::arquiMuca(GLuint frente, GLuint atras, GLuint lizq, GLuint lder, GLuint arriba)
{

	GLfloat vertice[8][3] = {
			{ 0.0, 0.0, 82.0 },     //Coordenadas Vértice 0 
			{ 57.0, 0.0, 82.0 },     //Coordenadas Vértice 1
			{ 57.0, 0.0, 0.0 },     //Coordenadas Vértice 2 
			{ 0.0, 0.0, 0.0 },     //Coordenadas Vértice 3 
			{ 0.0, 15.0, 82.0 },     //Coordenadas Vértice 4 
			{ 57.0, 15.0, 82.0 },     //Coordenadas Vértice 5 
			{ 57.0, 15.0, 0.0 },     //Coordenadas Vértice 6 
			{ 0.0, 15.0, 0.0 },     //Coordenadas Vértice 7 
	};
...
void CFiguras::arquiCuartoArriba(GLuint frente, GLuint atras, GLuint lizq, GLuint lder, GLuint arriba){

	GLfloat vertice[8][3] = {
			{ 57.0, 15.0, 78.0 },     //Coordenadas Vértice 0 
			{ 78.0, 15.0, 78.0 },     //Coordenadas Vértice 1
			{ 78.0, 15.0, 67.0 },     //Coordenadas Vértice 2 
			{ 57.0, 15.0, 67.0 },     //Coordenadas Vértice 3 
			{ 57.0, 22.0, 78.0 },     //Coordenadas Vértice 4 
			{ 78.0, 22.0, 78.0 },     //Coordenadas Vértice 5 
			{ 78.0, 22.0, 67.0 },     //Coordenadas Vértice 6 
			{ 57.0, 22.0, 67.0 },     //Coordenadas Vértice 7 
	};
...
void CFiguras::prisma(float altura, float largo, float profundidad, GLuint text, GLuint XREP, GLuint YREP)  //Funcion creacion prisma
{
	...
	glNormal3f(0.0f, 0.0f, 1.0f);
	glTexCoord2f(0.0f, 0.0f); glVertex3fv(vertice[0]);
	glTexCoord2f(0.0f, YREP); glVertex3fv(vertice[4]);
	glTexCoord2f(XREP, YREP); glVertex3fv(vertice[7]);
	glTexCoord2f(XREP, 0.0f); glVertex3fv(vertice[1]);
	glEnd();
	...
	glNormal3f(1.0f, 0.0f, 0.0f);
	glTexCoord2f(0.0f, 0.0f); glVertex3fv(vertice[0]);
	glTexCoord2f(XREP, 0.0f); glVertex3fv(vertice[3]);
	glTexCoord2f(XREP, YREP); glVertex3fv(vertice[5]);
	glTexCoord2f(0.0f, YREP); glVertex3fv(vertice[4]);
	glEnd();
	...
	//glColor3f(0.0,1.0,0.0);
	glNormal3f(0.0f, 0.0f, -1.0f);
	glTexCoord2f(0.0f, YREP); glVertex3fv(vertice[6]);
	glTexCoord2f(XREP, YREP); glVertex3fv(vertice[5]);
	glTexCoord2f(XREP, 0.0f); glVertex3fv(vertice[3]);
	glTexCoord2f(0.0f, 0.0f); glVertex3fv(vertice[2]);
	glEnd();
	...
	glTexCoord2f(0.0f, 0.0f); glVertex3fv(vertice[0]);
	glTexCoord2f(XREP, 0.0f); glVertex3fv(vertice[1]);
	glTexCoord2f(XREP, YREP); glVertex3fv(vertice[2]);
	glTexCoord2f(0.0f, YREP); glVertex3fv(vertice[3]);
	glEnd();
	...
	glNormal3f(0.0f, 1.0f, 0.0f);
	glTexCoord2f(0.0f, 0.0f); glVertex3fv(vertice[4]);
	glTexCoord2f(XREP, 0.0f); glVertex3fv(vertice[5]);
	glTexCoord2f(XREP, YREP); glVertex3fv(vertice[6]);
	glTexCoord2f(0.0f, YREP); glVertex3fv(vertice[7]);
	glEnd();
}
